...
// TWRProgressView
#define COCOAPODS_POD_AVAILABLE_TWRProgressView
#define COCOAPODS_VERSION_MAJOR_TWRProgressView 0
#define COCOAPODS_VERSION_MINOR_TWRProgressView 1
#define COCOAPODS_VERSION_PATCH_TWRProgressView 0
